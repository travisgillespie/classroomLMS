...
<?php
  // Unlike new_page.php, we don't need a menuBar_id to be sent
  // We already have it stored in page.menuBar_id.
  if (!$current_page) {
  ...
  <div id="page">
    ...
    <form action="edit_page.php?page=<?php echo urlencode($current_page["id"]); ?>" method="post">
      ...
      <p>Position:
        ...
        <?php
          $page_set = find_page_for_menuBar($current_page["menuBar_id"]);
      ...
      <p>Content:<br />
        <textarea name="content" rows="20" cols="75"><?php echo htmlentities($current_page["content"]); ?></textarea>
      </p>
